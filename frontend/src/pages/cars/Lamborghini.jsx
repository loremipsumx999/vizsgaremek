...
function Lamborghini() {
    ...
    const fetchLamborghini = async () => {
        try {
            const response = await fetch("http://localhost:3000/Lamborghini");
            ...
            setError("Hiba a Lamborghini-k lekérésénél.");
        }
    };
    ...
    return (
        <div className="mt-5">
            <h2 className="text-center mb-5">Lamborghini</h2>
            ...
            >
                {lamborghini.length > 0 ? (
                    ...
                    <p className="text-center">A pillanatban nincsenek Lamborghini autóink.</p>
                ) : null}
            </Masonry>
        </div>
    );
