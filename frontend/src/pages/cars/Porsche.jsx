...
function Porsche() {
    ...
    const fetchPorsche = async () => {
        try {
            const response = await fetch("http://localhost:3000/Porsche");
            ...
            setError("Hiba a Porsche-k lekérésénél.");
        }
    };
    ...
    return (
        <div className="mt-5">
            <h2 className="text-center mb-5">Porsche</h2>
            ...
            >
                {porsche.length > 0 ? (
                    ...
                    <p className="text-center">A pillanatban nincsenek Porsche autóink.</p>
                ) : null}
            </Masonry>
        </div>
    );
