            ...
            <Container className='text-center mt-4'>
                ...
                <Container className='mb-5 welcome bg-body-tertiary pt-3'>
                    <Row>
                        <Col xs={12} md={4} className='text-center'>
                            <p><span class="initial">Ü</span>dvözlünk a Race-001 Autókölcsönző weboldalán! Mi egy két fős csapat vagyunk, akiknek közös szenvedélye az autók világa. Hiszünk abban, hogy egy igazán különleges autó nem csupán egy közlekedési eszköz, hanem egy élmény, amely minden utazást felejthetetlenné tesz.
                ...
                <Container className='welcome bg-body-tertiary pt-3'>
                    <Row>
                        ...
                        <Col xs={12} md={4} className='text-center'>
                            <p><span class="initial">A</span>Race-001 Autókölcsönző weboldalán rengeteg prémium autó márka közül válogathatsz, így biztosan megtalálod azt a járművet, amelyik a legjobban illik hozzád. Legyen szó egy kényelmes városi autóról, vagy egy elegáns sportkocsiról, nálunk mindenki talál számára megfelelő opciót. Mi mindig a legjobb minőségre törekszünk, hogy az autózás élménye valóban különleges legyen.
