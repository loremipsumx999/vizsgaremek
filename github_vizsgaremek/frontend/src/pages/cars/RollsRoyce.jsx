...
function RollsRoyce() {
    ...
    const fetchRollsRoyce = async () => {
        try {
            const response = await fetch("http://localhost:3000/RollsRoyce");
            ...
            setError("Hiba a RollsRoyce-k lekérésénél.");
        }
    };
    ...
    return (
        <div className="mt-5">
            <h2 className="text-center mb-5">Rolls Royce</h2>
            ...
            >
                {rollsRoyce.length > 0 ? (
                    ...
                    <p className="text-center">A pillanatban nincsenek RollsRoyce autóink.</p>
                ) : null}
            </Masonry>
        </div>
    );
